...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Central de qualificação de leads imobiliários da MySide." },
      { name: "author", content: "MySide" },
      { property: "og:title", content: "Central de Qualificação de Leads — MySide" },
      { property: "og:description", content: "Central de qualificação de leads imobiliários da MySide." },
